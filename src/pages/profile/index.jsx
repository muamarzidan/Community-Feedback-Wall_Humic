    ...
    return (
        <div className="min-h-screen px-6 pt-30 bg-gray-50">
            ...
            <div className="max-w-3xl mx-auto space-y-6">
                <div className="flex items-center gap-4 p-6 bg-white border border-gray-300 shadow-sm rounded-2xl">
                ...
                <div className="p-6 bg-white border border-gray-300 shadow-sm rounded-2xl">
                ...
                <div className="flex flex-col p-6 bg-white border border-gray-300 shadow-sm rounded-2xl sm:flex-row sm:items-center sm:justify-between">
                    <div>
